...
public class CompletionResponse {
    ...
    public static List<CompletionResponse.Message> toResponseListBy(List<ChatCompletionChoice> choices) {
        return choices.stream()
                .map(completionChoice -> Message.of(completionChoice.getMessage()))
                .collect(Collectors.toList());
    }

    public static CompletionResponse of(ChatCompletionResult result) {
